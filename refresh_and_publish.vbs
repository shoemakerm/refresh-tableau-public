...
File = """C:\Users\Matt\Google Drive\Business\Practical Research Inc\CDC\United_States_COVID-19_Cases_and_Deaths_by_State_over_Time.tsv"""
CreateObject("WScript.Shell").Run App + " " + URL + " -o " + File

'Open Tableau Workbook
App = """C:\Users\Matt\Google Drive\Business\Practical Research Inc\CDC\Covid.twb"""
...
Shell_Object.SendKeys "{ENTER}"
WScript.Sleep 10000
'Turn NumLock back on becaue it gets turned off for some reason
WScript.Sleep 2000
